...
export const createUser = (data: {
  ...
  email?: string; mobile: string; hanghangCrmMobile?: string; mihuaWorkNumber?: string; avatar?: string;
...
export const updateUser = (id: number, data: {
  ...
  mobile: string; hanghangCrmMobile?: string; mihuaWorkNumber?: string; avatar?: string; roleId: number;
