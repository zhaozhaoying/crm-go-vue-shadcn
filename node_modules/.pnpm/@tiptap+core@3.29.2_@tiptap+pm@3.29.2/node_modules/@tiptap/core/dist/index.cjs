...
function canInsertNode(state, nodeType) {
  ...
  if (selection instanceof import_state14.NodeSelection) {
...
function inputRulesPlugin(props) {
  ...
  const plugin = new import_state15.Plugin({
    state: {
      init() {
        return null;
      },
  ...
  addProseMirrorPlugins() {
    return [
      new import_state17.Plugin({
        key: new import_state17.PluginKey("clipboardTextSerializer"),
        props: {
  ...
  addProseMirrorPlugins() {
    return [
      new import_state18.Plugin({
        key: new import_state18.PluginKey("tiptapDrop"),
        props: {
  ...
  addProseMirrorPlugins() {
    return [
      new import_state19.Plugin({
        key: new import_state19.PluginKey("editable"),
        props: {
...
var focusEventsPluginKey = new import_state20.PluginKey("focusEvents");
  ...
  addKeyboardShortcuts() {
    const handleBackspace = () => this.editor.commands.first(({ commands }) => [
      ...
      () => commands.command(({ tr }) => {
        ...
        const isAtStart = parentIsIsolating && $parentPos.parent.childCount === 1 ? parentPos === $anchor.pos : import_state21.Selection.atStart(doc).from === pos;
  ...
  addProseMirrorPlugins() {
    return [
      ...
      new import_state21.Plugin({
        key: new import_state21.PluginKey("clearDocument"),
        appendTransaction: (transactions, oldState, newState) => {
          ...
          const allFrom = import_state21.Selection.atStart(oldState.doc).from;
          const allEnd = import_state21.Selection.atEnd(oldState.doc).to;
  ...
  addProseMirrorPlugins() {
    return [
      new import_state22.Plugin({
        key: new import_state22.PluginKey("tiptapPaste"),
        props: {
  ...
  addProseMirrorPlugins() {
    return [
      new import_state23.Plugin({
        key: new import_state23.PluginKey("tabindex"),
        props: {
          attributes: () => {
            var _a;
  ...
  addProseMirrorPlugins() {
    return [
      new import_state24.Plugin({
        key: new import_state24.PluginKey("textDirection"),
        props: {
          attributes: () => {
...
var Editor = class extends EventEmitter {
  constructor(options = {}) {
    ...
    if (!this.editorState) {
      ...
      this.editorState = import_state25.EditorState.create({
        doc: initialDoc,
        schema: this.schema,
...
var NodeView = class {
  ...
  onDragStart(event) {
    ...
    const selection = import_state26.NodeSelection.create(view.state.doc, pos);
  ...
  stopEvent(event) {
    ...
    const isSelectable = import_state26.NodeSelection.isSelectable(this.node);
