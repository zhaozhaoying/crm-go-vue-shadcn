  ...
  <div class="w-full flex flex-col gap-4 lg:gap-6">
    <Card class="overflow-hidden border-border/60 shadow-sm">
      <CardHeader class="space-y-5 border-b bg-gradient-to-br from-background via-muted/10 to-background">
        ...
        <div class="flex flex-wrap items-center gap-3 rounded-2xl border bg-background/90 p-4 shadow-sm">
          ...
          <Table v-else class="min-w-[1860px]">
            <TableHeader class="sticky top-0 z-10 bg-muted/50">
              <TableRow>
                ...
                <TableHead
                  class="sticky right-0 z-20 w-[180px] min-w-[180px] border-l border-border bg-muted/95 text-center"
                >
                  操作
                </TableHead>
              </TableRow>
              ...
              <TableRow v-for="item in contracts" :key="item.id">
                ...
                <TableCell class="max-w-[240px] whitespace-normal break-all">
                  <a
                    ...
                    :href="resolveWebsiteUrl(item.websiteUrl)"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="text-sky-700 underline-offset-4 hover:underline"
